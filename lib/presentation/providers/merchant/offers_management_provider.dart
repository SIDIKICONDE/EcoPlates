...
final createOfferProvider =
    FutureProvider.family<Either<Failure, FoodOffer>, CreateOfferRequest>((
      ref,
      request,
    ) async {
...
final updateOfferProvider =
    FutureProvider.family<
      Either<Failure, FoodOffer>,
      ({String offerId, UpdateOfferRequest request})
    >((ref, params) async {
      final useCase = ref.watch(manageOffersUseCaseProvider);
      final merchantId = ref.watch(currentMerchantIdProvider);
...
final deleteOfferProvider =
    FutureProvider.family<
      Either<Failure, void>,
      ({String offerId, String? reason})
    >((ref, params) async {
      final useCase = ref.watch(manageOffersUseCaseProvider);
      final merchantId = ref.watch(currentMerchantIdProvider);
...
final duplicateOfferProvider =
    FutureProvider.family<
      Either<Failure, FoodOffer>,
      ({String offerId, DateTime? startTime, DateTime? endTime})
    >((ref, params) async {
      final useCase = ref.watch(manageOffersUseCaseProvider);
      final merchantId = ref.watch(currentMerchantIdProvider);
...
enum OffersViewFilter { all, active, draft, expired, today }
...
final offersFiltersProvider =
    StateNotifierProvider<OffersFiltersNotifier, OffersFilters>((ref) {
...
final merchantOffersProvider = FutureProvider<Either<Failure, List<FoodOffer>>>(
  (ref) async {
    final useCase = ref.watch(manageOffersUseCaseProvider);
    final merchantId = ref.watch(currentMerchantIdProvider);
    ...
    return result.fold((failure) => Left(failure), (offers) {
...
final offerByIdProvider =
    FutureProvider.family<Either<Failure, FoodOffer>, String>((
      ref,
      offerId,
    ) async {
...
final offerStatsProvider =
    FutureProvider.family<Either<Failure, OfferStats>, String>((
      ref,
      offerId,
    ) async {
      final useCase = ref.watch(manageOffersUseCaseProvider);
...
final toggleOfferStatusProvider =
    FutureProvider.family<
      Either<Failure, FoodOffer>,
      ({String offerId, bool activate})
    >((ref, params) async {
      final useCase = ref.watch(manageOffersUseCaseProvider);
      final merchantId = ref.watch(currentMerchantIdProvider);
...
final updateOfferStockProvider =
    FutureProvider.family<
      Either<Failure, FoodOffer>,
      ({String offerId, int quantity})
    >((ref, params) async {
      final useCase = ref.watch(manageOffersUseCaseProvider);
      final merchantId = ref.watch(currentMerchantIdProvider);
...
class OfferCreationNotifier extends StateNotifier<OfferCreationState> {
  ...
  OfferCreationNotifier(this._useCase, this._merchantId)
    : super(const OfferCreationState());
...
final offerCreationProvider =
    StateNotifierProvider<OfferCreationNotifier, OfferCreationState>((ref) {
      final useCase = ref.watch(manageOffersUseCaseProvider);
      final merchantId = ref.watch(currentMerchantIdProvider);
...
final todayActiveOffersProvider =
...
final offersCountByStatusProvider = Provider<Map<OfferStatus, int>>((ref) {
  ...
  return offersAsync.maybeWhen(
    data: (result) => result.fold((_) => {}, (offers) {
