            ...
            children: [
              ...
              TweenAnimationBuilder<double>(
                ...
                builder: (context, scale, child) => Transform.scale(
                  ...
                  imageUrl: widget.brand.category.brandBackgroundImageUrl,
                  ...
                  children: [
                    ...
                    Positioned.fill(
                      child: Padding(
                        padding: EdgeInsets.only(
                          bottom: FontSizes.titleMedium.getSize(context),
                        ),
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.brand.name,
                              style: TextStyle(
                                fontSize: FontSizes.titleMedium.getSize(
                                  context,
                                ),
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // Stats Row
                                  BrandStatsRow(
                                    activeOffers: widget.brand.activeOffers,
                                    averageDiscount: widget.brand.averageDiscount,
                                  ),
                                ],
                              ),
                            ),
                    ...
                    Align(
                      ...
                      child: AnimatedContainer(
                        ...
                        curve: Curves.easeOut,
                        width: _isHovered 
                            ? FontSizes.titleLarge.getSize(context) * 1.1
                            : FontSizes.titleLarge.getSize(context),
                        height: _isHovered 
                            ? FontSizes.titleLarge.getSize(context) * 1.1
                            : FontSizes.titleLarge.getSize(context),
                        padding: EdgeInsets.all(
                          ResponsiveUtils.getHorizontalSpacing(context) * 0.25,
                        ),
                        decoration: BoxDecoration(
                          ...
                          children: [
                            Center(
                              child: EcoCachedImage(
                                ...
                                width: FontSizes.bodyLarge.getSize(context),
                                height: FontSizes.bodyLarge.getSize(context),
                                fit: BoxFit.contain,
