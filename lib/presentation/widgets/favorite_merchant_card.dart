                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              onPressed: () {
                                ref.read(favoriteMerchantIdsProvider.notifier).toggleFavorite(merchant.id);
                                ...
                                if (context.mounted) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      ...
                                      backgroundColor: isFavorite ? Colors.grey[700] : Colors.green[700],
                                    ),
                                  );
                                }
                              },
                              icon: AnimatedSwitcher(
                                ...
                                child: Icon(
                                  ...
                                  size: 20,
                                  color: isFavorite ? Colors.red[500] : Colors.grey[600],
                                ),
                              ),
                          ...
                          child: BackdropFilter(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  colors: [
                                    ...
                                    Colors.pink[50]!.withOpacity(0.6),
                                  ],
                                ),
                                borderRadius: BorderRadius.circular(10),
                                border: Border.all(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(Icons.favorite, size: 12, color: Colors.pink[600]),
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        Text(r.toStringAsFixed(1), style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600)),
      ],
    );
  }
}
